        ...
        return (
            <Deck transition={["zoom", "slide"]} theme={theme} transitionDuration={500}>
                ...
                <Slide transition={["zoom"]}>
                  <Image width='100%' src='http://altitudelabs.com/blog/content/images/2017/08/react-native-hybrid-apps.png'/>
                </Slide>
                <Slide transition={["zoom"]}>
                  <Image width='75%' src='https://www.logicroom.co/react-native-architecture-explained/images/3_image.png'/>
                </Slide>
                <Slide transition={["zoom"]}>
                ...
                <Slide transition={["zoom", "fade"]} bgColor="primary">
                  <Layout>
                      <Fill>
                        <List>
                            <Appear><ListItem>Réfléchir son UI avec des composants</ListItem></Appear>
